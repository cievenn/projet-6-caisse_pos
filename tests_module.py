...
def setup_db():
    ...
    with module.get_db() as conn:
        ...
        conn.execute("INSERT INTO products (id, name, price_ht, vat_rate, stock, is_active) VALUES (1, 'Produit Test', 100.0, 0.21, 10, 1)")
        conn.execute("INSERT INTO products (id, name, price_ht, vat_rate, stock, is_active) VALUES (2, 'Produit Faible', 50.0, 0.06, 2, 1)")
